...
router.get("/:property_id", async (ctx) => {
  ...
  try {
    ...
    // Armamos el cuerpo de la solicitud como el JobService espera
    ...
    // Esperar la respuesta final del job
    ...
    // Devolvemos la respuesta tal cual llega del servicio
    ctx.status = 200;
